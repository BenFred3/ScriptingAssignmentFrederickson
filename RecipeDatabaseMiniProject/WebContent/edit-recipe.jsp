...
<body>
	...
	<form action = "editRecipeServlet" onsubmit = "return submitCheckEdit()" method="post">
		Recipe Name: <input type ="text" name = "recipeName" id = "recipeName" size= "40" value="${recipeToEdit.recipeName}">
		<br>
		Recipe Type: <input type = "text" name = "recipeType" id = "recipeType" value="${recipeToEdit.recipeType}">
		<br>
		Date Added: <input type = "text" name = "dateAdded" value="${recipeToEdit.dateAdded}" readonly>
		<br>
		Calories: <input type = "text" name = "calories" id = "calories" value="${recipeToEdit.calories}">
		<br>
		Prep Time: <input type = "text" name = "prepTime" id = "prepTime" value="${recipeToEdit.prepTime}">
		<br>
